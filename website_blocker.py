...
Label(window,text='Developed By @Shruti',font=('bold',12),fg='purple').pack(side=BOTTOM)
...
Button(window,text='Block',font=('bold',10),bg='red',fg='black',command=block).place(x=150,y=100)
Button(window,text='Un Block',font=('bold',10),bg='green',fg='black',command=unblock).place(x=270,y=100)
Button(window,text='Exit',font=('bold',10),bg='yellow',fg='black',command=close).place(x=400,y=100)
window.mainloop()